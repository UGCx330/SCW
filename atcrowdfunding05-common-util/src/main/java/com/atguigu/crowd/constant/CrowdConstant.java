...
public class CrowdConstant {
	...
	public static final String ATTR_NAME_PROJECTS_DATA = "pageInfo_projects_data";

	public static final String REDIS_CODE_PREFIX = "REDIS_CODE_PREFIX_";

    public static final String MESSAGE_PHONE_NOT_EXISTS = "请先发送验证码";
	public static final String ATTR_ID_PROJECT = "projectId";
	public static final String MESSAGE_CANNOT_FOLLOW ="您已关注过了";
    public static final String MESSAGE_CANNOT_DELFOLLOW = "您已取消关注过了";
	public static final String ATTR_NAME_PERSONAL_ALL_PROJECT = "personalAllProject";
    public static final String MESSAGE_CANNOT_DELORDER = "订单删除失败，请联系管理员";
	public static final String ATTR_NAME__PROJECT_PAGE_INFO = "projectPageInfo";
}
