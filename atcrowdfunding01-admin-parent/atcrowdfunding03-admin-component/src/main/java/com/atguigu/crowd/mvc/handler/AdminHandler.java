...
public class AdminHandler {
    ...
    @RequestMapping("admin/get/project/page.html")
    public String getProject(
            ...
            ModelMap modelMap) {
        // 调用Service方法获取PageInfo对象
        PageInfo<Project> pageInfo = adminService.getProjectPageInfo(keyword, pageNum, pageSize);
        // 将PageInfo对象存入模型
        modelMap.addAttribute(CrowdConstant.ATTR_NAME_PAGE_INFO, pageInfo);
        return "project-page";
    }

    @RequestMapping("allow/project.html")
    public String allowProject(@RequestParam("projectId") Integer projectId) {
        adminService.allowProject(projectId);
        return "redirect:/admin/get/project/page.html";
    }

    @RequestMapping("deAllow/project.html")
    public String deAllowProject(@RequestParam("projectId") Integer projectId) {
        adminService.deAllowProject(projectId);
        return "redirect:/admin/get/project/page.html";
    }
}