...
<%--							class="glyphicon glyphicon-check"></i> 广告审核</a></li>--%>
					<li style="height: 30px;"><a href="admin/get/project/page.html"><i
							class="glyphicon glyphicon-check"></i> 项目审核</a></li>
				</ul></li>
			<li class="list-group-item tree-closed" style="pointer-events: none;"><span><i
					class="glyphicon glyphicon-th-large"></i> 业务管理(待开发) <span class="badge"
			...
			<li class="list-group-item tree-closed" style="pointer-events: none;"><a href="param.html"><i
					class="glyphicon glyphicon-list-alt"></i> 参数管理(暂无参数)</a></li>
		</ul>
	</div>
</div>